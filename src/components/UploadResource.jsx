      ...
      <div className="flex items-start justify-between gap-4">
        ...
        <div>
          ...
          <p className="mt-2 text-sm leading-relaxed text-slate-400">
            Share a useful link or upload a
            file for your classmates.
          </p>
      ...
      {mode === "link" && (
        <div className="mt-5">
          ...
          <div className="mt-3 flex items-center gap-2 text-xs text-slate-500">
            YouTube links will automatically
            be added as videos.
          </div>
      ...
      {mode === "file" && (
        <div className="mt-5">
          ...
          <label className="group flex cursor-pointer flex-col items-center justify-center rounded-2xl border border-dashed border-white/15 bg-white/[0.03] px-6 py-10 text-center transition hover:border-white/30 hover:bg-white/[0.06]">
            ...
            <input
              type="file"
              accept=".pdf,.doc,.docx,.ppt,.pptx,.jpg,.jpeg,.png,.webp,.gif,.mp4,.webm,.mov"
              onChange={(e) =>
                setFile(
                  e.target.files?.[0] ||
                    null
